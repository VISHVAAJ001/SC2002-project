...
public class EligibilityService implements IEligibilityService {
    ...
    @Override
    public boolean checkApplicationEligibility(Applicant applicant, Project project) {
    ...
    @Override
    public boolean checkOfficerRegistrationEligibility(HDBOfficer officer, Project project,
