...
public class ApplicationController {
    ...
    public ApplicationController(Map<String, Application> appMap, Map<String, Project> projMap, IDataManager dataMgr, IEligibilityService eligSvc){
    ...
    public boolean submitApplication(Applicant applicant, String projectId) throws ApplicationException{
        if (!eligibilityService.canApplicantApply(applicant, projectRepo.get(projectId))){
            throw new ApplicationException("Applicant is not eligible to apply for project.");
        }

        Application application = new Application(applicationId, applicant.getNric(), projectId);
